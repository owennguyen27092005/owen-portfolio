          ...
          <div className="space-y-16">
            ...
            >
              <div className="flex items-center gap-4 mb-2">
                  ...
                  <div className="flex-grow min-w-0 flex flex-col md:flex-row md:items-start justify-between">
                    ...
                    <div className="text-white/60 text-base font-normal mt-1 md:mt-0 md:text-right leading-[1.6] md:leading-[2.6rem]">Indianapolis, IN</div>
                  </div>
                </div>
                <div className="md:pl-20 space-y-1 mb-4">
                  <div className="flex flex-col md:flex-row md:items-baseline justify-between">
                    <div className="text-xl text-white font-medium">Incoming Strategic Finance Analyst</div>
            ...
            >
               <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-grow min-w-0 flex flex-col md:flex-row md:items-start justify-between">
                    <div>
                      <h3 className="text-highlight text-2xl md:text-[2rem] font-heading font-semibold">Vietnam-Russia Bank</h3>
                      <div className="text-xl text-white font-medium">Financial Analyst Intern</div>
                    </div>
                    <div className="mt-1 md:mt-0 md:text-right">
                      ...
                      <div className="text-white/60 text-base font-normal">June 2025 - Aug 2025</div>
                    </div>
                  </div>
                </div>
        ...
        <section id="projects" className="max-w-6xl mx-auto px-6 py-24">
          ...
          <div className="flex md:justify-start gap-6 overflow-x-auto snap-x snap-mandatory hide-scrollbar py-8 px-4 -mx-4">
            ...
            >
              <div className="p-6 flex-grow">
                ...
                <div className="space-y-4 text-white/80 text-[0.95rem] leading-relaxed mb-6">
                  ...
                  <p><strong>Analysis:</strong> Helped build a controlled 2×2 experimental design varying writing source (human-written vs. AI-polished) and candidate signal (domestic vs. international) while holding qualifications, experience, and structure constant, then collected screening ratings through a live survey instrument. </p>
                  <p><strong>Outcome:</strong> Deployed the survey as a live web application and structured the response data for comparison across conditions to isolate the effect of each variable on evaluator judgment. </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-6 pt-0 mt-auto">
                <div className="flex flex-wrap gap-2">
                  <span className="bg-white/5 text-white/70 px-3 py-1 rounded-full text-xs border border-white/10">Predictive Modeling</span>
                  <span className="bg-white/5 text-white/70 px-3 py-1 rounded-full text-xs border border-white/10">Python</span>
                  <span className="bg-white/5 text-white/70 px-3 py-1 rounded-full text-xs border border-white/10">Data Analysis</span>
                  <span className="bg-white/5 text-white/70 px-3 py-1 rounded-full text-xs border border-white/10">Statistics Modeling</span>
                  <span className="bg-white/5 text-white/70 px-3 py-1 rounded-full text-xs border border-white/10">Data Collection & Organization</span>
                </div>
              </div>
            </motion.div>
